...
\author{Vitor Gabriel Andrade Teixeira}  % Seu nome
\authorbib{Andrade, Vitor} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{PRISM - Padrão de Rótulos e Interfaces para Sistemas Médicos} % Título do trabalho
\titleen{PLIMS - Pattern of Labels and Interfaces for Medical Systems} % Título traduzido para inglês
\advisor{Prof. Dr. José Jair Alves Mendes Junior} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
% Se não houver corientador, comente a linha a baixo
\coadvisor{Msc. María Verónica González Méndez, Msc. Augusto Inafuco } % Nome do coorientador, caso exista. Caso não exista, comente a linha.

\depositshortdate{202} % Ano em que depositou este documento
\approvaldate{01/janeiro/2025}
