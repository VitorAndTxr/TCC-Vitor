...
Esse deficit de diretivas é extremamente danoso, pois, além do risco de retrabalho, gera esforço extra para a pesquisa em normalização dos dados para cada nova fonte de dados. lança desconfiança sobre sistemas e soluções construídas a partir dos dados extraídos. Esse fato dificulta a aceitação e difusão de projetos que se baseiam na sintetização de informações presentes em grandes quantidades de dados, como o caso de soluções desenvolvidas a partir de ML.
...
\begin{figure}[htb]%% Ambiente figure
    %\captionsetup{width=0.55\textwidth}%% Largura da legenda
    \caption{Proposta do autor}%% Legenda
