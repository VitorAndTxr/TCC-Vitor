...
A figura \ref{fig:reducao} abaixo mostra o exemplo do processo de redução do PRISM aplicado a um projeto de tratamento por estimulação eletrica funcional (FES) que possui um sistema de captura de biossinais de sEMG.

\begin{figure}[htb]
    \caption{Exemplo do processo de redução de um projeto ao PRISM} 
	\label{fig:reducao}
	\centering
	\subfloat[Diagrama base do projeto]{
    \includegraphics[scale=0.5]{figuras/metodologia/FESTraduzido.png}
	}
    \hspace{0.15cm} 
	\subfloat[Identificação dos componentes de acordo com o PRISM]{
		\includegraphics[scale=0.5]{figuras/metodologia/FESpre-reducao.png}
	}
    \hspace{0.15cm} 
	\subfloat[Representação do projeto após redução ao PRISM]{
		\includegraphics[scale=0.6]{figuras/metodologia/FESReduzido.png}
	}
...
Explicar o processo de coleta para mostrar facilidade
