...
A nível de usuário, uma vez a aplicação cliente possuindo uma uma sessão aberta com o servidor, permite os
...
\newpage
\section{Interface de Pesquisa Interoperável}\label{sec:desenvolvimentoProjetoExemplo}
...
\section{Integração do Projeto Exemplo}\label{sec:desenvolvimentoProjetoExemplo}
