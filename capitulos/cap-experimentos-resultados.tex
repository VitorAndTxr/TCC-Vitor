...
Falar sobre escolhas técnicas para montar o projeto do nó e principais estruturas

Falar sobre escolhas técnicas para montar o projeto do nó e principais estruturas

Falar sobre o que será e um resumo da estrutura do projeto

falar sobre o back-end do Nó e tecnologias usadas


\subsection{Arquitetura}

\subsection{Autenticação, Identificação e Liberação}
