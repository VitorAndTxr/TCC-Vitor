...
A Seção~\ref{sec:resultadosSincronizacao}, demonstra a operação fim a fim do PRISM \textit{Middleware} ao sincronizar dados de pesquisa criados em um NPI para outro, evidenciando a estrutura dos arquivos efetivamente exportados. E a Seção~\ref{subsec:resultadosSincIdempotencia} expõem experimentalmente como o sistema tratou o compartilhamento de dados e a gestão de dados compartilhados entre dois NPIs.
...
A Listagem~\ref{codigo:resultadosSincPayloadJson} refere-se ao conteúdo do JSON que representa o objeto de uma gravação exportada de uma pesquisa do IRIS a partir do NPI B.
...
A Listagem~\ref{codigo:resultadosSincRecordJson} refere-se ao conteúdo do JSON que representa o objeto de uma gravação exportada de uma pesquisa do IRIS a partir do NPI B.
...
A Listagem~\ref{codigo:resultadosSincCsvCabecalho} refere-se ao conteúdo do CSV que armazena o registro do sinal sEMG da pesquisa exportada do IRIS a partir do NPI B.
...
A Figura~\ref{fig:resultadossEMGPlot} é um plot do arquivo CSV do o registro do sinal sEMG da pesquisa exportada do IRIS a partir do NPI B.
