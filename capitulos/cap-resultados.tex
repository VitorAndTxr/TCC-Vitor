...
A Seção~\ref{sec:resultadosSincronizacao}, demonstra a operação fim a fim do PRISM \textit{Middleware} ao sincronizar dados de pesquisa criados em um NPI para outro, evidenciando a estrutura dos arquivos efetivamente exportados.
