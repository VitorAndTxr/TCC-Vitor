...
A Seção~\ref{sec:resultadosSincronizacao} descreve o cenário experimental, demonstra a operação fim a fim do protocolo entre os dois NPIs federados e evidencia a estrutura dos artefatos efetivamente exportados pelo nó consumidor. Em seguida, a Subseção~\ref{subsec:resultadosSincIdempotencia} apresenta os experimentos que verificam as propriedades de idempotência e de \textit{last-write-wins} declaradas no contrato de troca de dados entre nós.
