...
%%\include{./capitulos/citacoes}%% Comente para remover este item
...
\begin{arquivosdeapendices}%% Os arquivos de apêndices devem se incluídos neste ambiente - Não comente esta linha
    ...
    \include{./PosTexto/apendice-diagramas-sequencia}%% Apêndice - Comente para remover este item

  \include{./PosTexto/apendice-ref-api}%% Apêndice - Comente para remover este item
  \include{./PosTexto/apendice-telas}%% Apêndice - Comente para remover este item
    \include{./PosTexto/apendice-diagramas-banco}%% Apêndice - Comente para remover este item
