...
\begin{figure}[htpb]
\caption{Tela de sessão ativa do IRIS \textit{Mobile}(a), com a listagem das gravações e das anotações associadas à sessão em curso(b).}
...
\begin{figure}[htpb]
\caption{Tela de captura ao vivo do IRIS \textit{Mobile}, com o gráfico do sinal sEMG e controles de gravação, (a) bíceps em repouso e (b) bíceps contraído}
